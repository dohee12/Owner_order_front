            ...
            return (
              <li
                ...
                className={`p-4 border-b cursor-pointer hover:bg-gray-50 ${
                  selectedOrderId === order.oid ? "bg-blue-50" : ""
                }`}
                ...
                <div className="flex gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-700">
                      ...
                      <div className="text-gray-500">{getOrderTotal(order).toLocaleString()}원</div>
                    </div>
                  </div>
                  {nextStatus && nextButtonLabel && (
                    <div className="flex items-center">
                      <button
                        ...
                        className="w-full h-full px-3 py-1 text-xs text-white bg-blue-500 rounded hover:bg-green-600"
                        onClick={(e) => {
                          e.stopPropagation();
